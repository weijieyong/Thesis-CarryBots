...
%   \begin{minipage}{0.5\hsize}
%     \centering
%      \includegraphics[width=0.7\columnwidth]{./figure/freebody.pdf}
...
さらに，わかりやすくするために，\eqref{F-solve}式の右辺の1項目のロボット1からの垂直抗力$N_{r_1 o}$とロボット2からの垂直抗力$N_{r_2 o}$に着目する．\reffig{freebody}に示すようなそれぞれのロボットの前進力$F_{r_1}$，$F_{r_2}$，ロボットと台車の間の摩擦力$f_{tr_1}$，$f_{tr_2}$で表現すると，
% また，\eqref{F-solve}式の1項目のロボット1からの垂直抗力$N_{r_1 o}$とロボット2からの垂直抗力$N_{r_2 o}$を\reffig{freebody}に示すようにロボット1の前進力$F_{r_1}$，ロボット2の前進力$F_{r_2}$，ロボット1と台車の間の摩擦力$f_{tr_1}$，ロボット2と台車の間の摩擦力$f_{tr_2}$で表現すると，
\begin{equation}
